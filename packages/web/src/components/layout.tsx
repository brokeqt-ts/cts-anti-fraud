...
import { LayoutDashboard, Users, ShieldBan, Globe, Settings, Plus, Shield, Link2, BarChart3, ShieldCheck, Brain, LogOut, UserCog, Bell, BellRing, BookOpen, Search, TrendingUp } from 'lucide-react';
...
export function Layout() {
  ...
  const navItems = user?.role === 'admin'
    ? [...baseNavItems.slice(0, -1), { to: '/users', label: 'Пользователи', icon: UserCog }, { to: '/admin/buyers', label: 'Статистика Байеров', icon: TrendingUp }, { to: '/admin/notifications', label: 'Упр. уведомлениями', icon: BellRing }, baseNavItems[baseNavItems.length - 1]]
    : baseNavItems;
