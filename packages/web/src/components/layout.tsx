...
import { LayoutDashboard, Users, ShieldBan, Globe, Settings, Plus, Shield, Link2, BarChart3, ShieldCheck, Brain, LogOut, UserCog, Bell, BellRing, BookOpen, Search, ClipboardList, TrendingUp } from 'lucide-react';
...
export function Layout() {
  ...
  const navItems = user?.role === 'admin'
    ? [...baseNavItems.slice(0, -1), { to: '/users', label: 'Пользователи', icon: UserCog }, { to: '/admin/buyers', label: 'Buyer Performance', icon: TrendingUp }, { to: '/admin/notifications', label: 'Упр. уведомлениями', icon: BellRing }, { to: '/admin/audit', label: 'Аудит', icon: ClipboardList }, baseNavItems[baseNavItems.length - 1]]
    : baseNavItems;
