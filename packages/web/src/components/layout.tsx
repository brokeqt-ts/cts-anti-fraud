...
export function Layout() {
  ...
  const navItems = user?.role === 'admin'
    ? [...baseNavItems.slice(0, -1), { to: '/users', label: 'Пользователи', icon: UserCog }, { to: '/admin/notifications', label: 'Упр. уведомлениями', icon: BellRing }, { to: '/admin/rules', label: 'Правила рисков', icon: SlidersHorizontal }, baseNavItems[baseNavItems.length - 1]]
    : baseNavItems;
